<script setup>
    import {contentPinia} from "../../store/content.js";
    import { utilityPinia } from "../../store/utility";

    const storeUtility = utilityPinia();
    const storeContent = contentPinia();
    ...
    $( function() {
        ...
        $("#sortableContent").sortable({
            update: function (event, ui) {
                ...
                storeContent.content_sort = data;
                // storeManufacture.onSortManufacture(data);
                console.log("call sortableManufacturer 2",data);
...
<template>
    ...
    <div class="modal  reorder-modal" id="reorderContent">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">

                <div class="modal-header">
                    <h4 class="modal-title">{{$t('Reorder content in the app')}}</h4>
                ...
                <div class="reorder-modal-container" id="sortableContent">

                    <template v-if="storeContent.lists">
                        <template v-for="single in storeContent.lists" :key="single.id">
                ...
                <div class="modal-footer">
                    ...
                    <div class="modal-footer-buttons">
                        <a  class="btn-large btn-gray" @click="storeContent.onClickReorder">{{$t('Cancel')}}</a>
                        <a  class="btn-large btn-dark-blue" @click="storeContent.onSortContent()">{{$t('Save')}}</a>
