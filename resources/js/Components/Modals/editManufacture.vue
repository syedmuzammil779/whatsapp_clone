<script setup>
    ...
    function  onRemoveLogo(){
        storeManufacture.manufacture.logo = '';
    }
...
<template>
    ...
    <div class="modal  add-relation-modal" id="editManufacture">
        <div class="modal-dialog">
            <div class="modal-content">

                <div class="modal-header">
                    <h4 class="modal-title">{{$t('Edit')}} {{$t('manufacturer')}}</h4>
                ...
                <div class="modal-form">
                    ...
                    <div class="custom-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control d-none" id="manufacture_logo" placeholder="Enter name">
                            <div class="custom-file-picker" v-if="!storeManufacture.manufacture.logo" @click="open">
                                <span>{{$t('Select')}}</span>
                            ...
                            <div class="manufacture-logo-edit" v-if="storeManufacture.manufacture.logo">
                               <span class="manufacture-logo-edit-remove" @click="onRemoveLogo()">
                                    <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.75 3L3.75 9" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M3.75 3L9.75 9" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                               </span>

                                <img :src="storeManufacture.manufacture.logo" />
                            </div>
                        </div>
                        ...
                        <div class="form-btn-container">
                            <a class="btn-large btn-gray cursor-pointer" @click="storeManufacture.onCloseModal(1)">{{$t('Discard')}}</a>
                            <a class="btn-large btn-dark-blue cursor-pointer" @click="storeManufacture.onUpdateManufacture()">{{$t('Save changes')}}</a>
                        </div>
